...
Switch to branch "NewDirection". Download this branch. Find the "OLD CODE NEW PROJ" directory. Move to the "BattleBoats" subdirectory within this "OLD CODE NEW PROJ" folder and run pod install. Open the BattleBoats.xcworkspace in "OLD CODE NEW PROJ"/Battleboats to run the app.
